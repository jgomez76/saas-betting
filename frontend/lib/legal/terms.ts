...
> = {
    en: {
...

        {
            ...
            "You are responsible for all activity carried out using your account.",
...

        {
            ...
            "Do not misuse automated systems or bots.",
            "Do not copy or redistribute premium content without permission.",
    ...
    es: {
...

        {
            ...
            "Nos reservamos el derecho de suspender cuentas que incumplan estos Términos del Servicio."
            ]
        },

        {
            ...
            bullets: [
            "No intentes comprometer la seguridad de la plataforma.",
            "No utilices sistemas automatizados o bots de forma indebida.",
            "No copies ni redistribuyas contenido Premium sin autorización.",
            "Utiliza la plataforma respetando la legislación aplicable."
            ]
        },
...

        {
            ...
            content: [
            "Si tienes cualquier duda sobre estos Términos del Servicio, puedes ponerte en contacto con nosotros."
            ],
    ...
    sections: [
        ...
        bullets: [
            "Ne tentez pas de compromettre la sécurité de la plateforme.",
            "N'utilisez pas de systèmes automatisés ou de robots de manière abusive.",
            "Ne copiez ni ne redistribuez le contenu Premium sans autorisation.",
            "Utilisez la plateforme conformément à la législation applicable."
        ]
        },
        ...
        content: [
            "Pour toute question concernant les présentes Conditions d'utilisation, veuillez nous contacter."
        ],
    ...
    sections: [
        ...
        bullets: [
            "Sei responsabile della riservatezza del tuo account.",
            "Devi fornire informazioni corrette durante la registrazione.",
            "Sei responsabile di tutte le attività effettuate tramite il tuo account.",
            "Ci riserviamo il diritto di sospendere gli account che violano i presenti Termini di Servizio."
        ]
        },

        {
        title: "4. Utilizzo consentito",

        bullets: [
            "Non tentare di compromettere la sicurezza della piattaforma.",
            "Non utilizzare sistemi automatizzati o bot in modo improprio.",
            "Non copiare né ridistribuire contenuti Premium senza autorizzazione.",
            "Utilizza la piattaforma nel rispetto delle leggi applicabili."
        ]
        },
