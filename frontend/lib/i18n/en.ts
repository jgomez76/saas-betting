export const en = {
    ...
    contactDescription:
      "If you have questions, suggestions, bug reports, partnership proposals, or account-related issues, please contact us using the information below.",
    ...
    feedbackDescription:
      "We welcome feedback and suggestions to improve Luranix and deliver a better experience for all users.",

    businessInquiries: "Business Inquiries",

    businessDescription:
      "For partnerships, commercial opportunities, or media inquiries, please contact:",
    ...
    cookieDescription:
      "We use cookies to improve your experience on Luranix.",
