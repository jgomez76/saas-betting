...
import { buildMatchInsights } from "@/lib/ai/matchInsights";
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-3 min-w-0">
        ...
        <select
          ...
          className="w-full min-w-0 p-3 rounded-xl bg-[var(--input)] border border-[var(--border)]"
        >
        ...
        <select
          ...
          className="w-full min-w-0 p-3 rounded-xl bg-[var(--input)] border border-[var(--border)] disabled:opacity-50"
        >
