  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 w-full">
      ...
      <div className="flex-1 w-full">
        ...
        {table.length > 0 && (
          <div className="bg-[#1f2937] rounded-lg p-3 border border-[#333] w-full">
            ...
            {/* 🏷 HEADER */}
            <div className="grid grid-cols-[30px_1fr_40px_70px_40px] text-xs text-gray-400 mb-2 px-2">
              <span>#</span>
              <span>Equipo</span>
            ...
            <div className="flex flex-col gap-1">
              ...
              {table.map((t, i) => (
                <div
                  key={t.team}
                  className="grid grid-cols-[30px_1fr_40px_70px_40px] items-center bg-[#2a2a2a] rounded px-2 py-2 text-xs"
                >
                  {/* POS */}
                  <span
                    className={`
                      text-center
                      ${i < 4 ? "text-green-400 font-semibold" : ""}
                      ${i >= table.length - 3 ? "text-red-400 font-semibold" : ""}
                    `}
                  >
                    {i + 1}
                  </span>
